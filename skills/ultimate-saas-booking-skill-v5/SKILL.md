...
description: Project-local engineering and architecture standard for building, auditing, stabilizing, and completing Diamond Booking (multi-tenant B2B SaaS booking platform).
---

# Ultimate SaaS Booking Skill (v5)

This project-local skill defines the non-negotiable engineering and architecture operating contract for the Diamond Booking platform lifecycle: auditing, debugging, refactoring, scaling, UI/UX generation, and feature completion.
...
- Provide a short system impact summary (what changed, what didn’t)
- Provide file pointers for key diffs
- Provide a verification checklist (commands and manual flows)

## Project Context

Repository-specific context, audit notes, and remediation plans live here:

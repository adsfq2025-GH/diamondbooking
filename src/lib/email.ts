  ...
  <table width="100%" cellpadding="0" cellspacing="0">
    <tr><td align="center" style="padding:40px 20px">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,0.08)">
        <!-- Header -->
        <tr><td style="background:#0b5c8b;padding:32px 40px;text-align:center">
            ...
            <tr><td style="padding:24px">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:16px">
                <tr>
                  ...
                  <td style="font-size:15px;color:#0b5c8b;font-weight:600">${value}</td>
                </tr>
              </table>`).join("")}
            </td></tr>
          </table>
...
<body style="margin:0;padding:40px 20px;background:#f5f5f5;font-family:Arial,sans-serif">
  <div style="max-width:500px;margin:0 auto;background:#fff;border-radius:12px;padding:32px;box-shadow:0 2px 8px rgba(0,0,0,0.06)">
    <p style="margin:0 0 4px;font-size:20px;font-weight:700;color:#0b5c8b">📅 New booking</p>
    ...
    <table width="100%" cellpadding="8" style="border-collapse:collapse;font-size:14px">
      ${[
        ...
        ["When",    dateStr],
      ].map(([k, v]) => `<tr style="border-bottom:1px solid #f0f0f0"><td style="color:#999;width:80px">${k}</td><td style="color:#0b5c8b;font-weight:600">${v}</td></tr>`).join("")}
    </table>
...
<body style="margin:0;padding:40px 20px;background:#f5f5f5;font-family:Arial,sans-serif">
  <div style="max-width:500px;margin:0 auto;background:#fff;border-radius:12px;padding:32px">
    <p style="margin:0 0 16px;font-size:20px;font-weight:700;color:#0b5c8b">⏰ Reminder: You have an appointment tomorrow</p>
    ...
    <div style="background:#f8f9ff;border-radius:8px;padding:20px;margin:16px 0">
      <p style="margin:0 0 8px;font-size:15px;font-weight:700;color:#0b5c8b">${data.serviceName}</p>
...
<body style="margin:0;padding:40px 20px;background:#f5f5f5;font-family:Arial,sans-serif">
  <div style="max-width:500px;margin:0 auto;background:#fff;border-radius:12px;padding:32px">
    <p style="margin:0 0 16px;font-size:20px;font-weight:700;color:#0b5c8b">Thanks, ${data.customerName}</p>
...
<body style="margin:0;padding:40px 20px;background:#f5f5f5;font-family:Arial,sans-serif">
  <div style="max-width:500px;margin:0 auto;background:#fff;border-radius:12px;padding:32px">
    <p style="margin:0 0 16px;font-size:20px;font-weight:700;color:#0b5c8b">Booking Cancelled</p>
...
<body style="margin:0;padding:40px 20px;background:#f5f5f5;font-family:Arial,sans-serif">
  <div style="max-width:500px;margin:0 auto;background:#fff;border-radius:12px;padding:40px">
    <div style="text-align:center;margin-bottom:32px">
      <div style="width:56px;height:56px;background:#0b5c8b;border-radius:14px;display:inline-flex;align-items:center;justify-content:center;font-size:24px">💎</div>
    </div>
    <p style="font-size:22px;font-weight:800;color:#0b5c8b;margin:0 0 8px">Welcome, ${name}!</p>
    ...
    <div style="display:flex;align-items:flex-start;gap:12px;margin-bottom:16px">
      <div style="width:28px;height:28px;background:#f5c84c;border-radius:8px;color:#0b5c8b;font-weight:800;font-size:12px;display:flex;align-items:center;justify-content:center;flex-shrink:0">${i + 1}</div>
      <p style="margin:0;padding-top:4px;font-size:14px;color:#555">${s}</p>
    </div>`).join("")}
    <a href="${process.env.NEXT_PUBLIC_APP_URL}/dashboard" 
       style="display:block;text-align:center;padding:14px;background:#0b5c8b;color:#fff;font-weight:700;font-size:15px;border-radius:12px;text-decoration:none;margin-top:24px">
      Go to Dashboard →
    </a>
  </div>
</body>
...
<body style="margin:0;padding:40px 20px;background:#f5f5f5;font-family:Arial,sans-serif">
  <div style="max-width:520px;margin:0 auto;background:#fff;border-radius:12px;padding:32px">
    <p style="margin:0 0 12px;font-size:18px;font-weight:800;color:#0b5c8b">Reset your password</p>
    <p style="margin:0 0 18px;font-size:14px;color:#555;line-height:1.6">
      Click the button below to set a new password. This link expires in 1 hour.
    </p>
    <a href="${resetUrl}"
       style="display:inline-block;padding:12px 16px;background:#0b5c8b;color:#fff;font-weight:700;font-size:14px;border-radius:10px;text-decoration:none">
      Reset password
    </a>

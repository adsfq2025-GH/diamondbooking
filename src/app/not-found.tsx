  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-6">
      <Image
        ...
        priority
      />
      <h1 className="text-6xl font-black text-[#0b5c8b] mb-2">404</h1>
      ...
      <div className="flex gap-3">
        <Link href="/" className="px-5 py-2.5 bg-[#0b5c8b] text-white text-sm font-semibold rounded-xl hover:bg-[#0b5c8b]/90 transition-colors">
          Go home
        </Link>
